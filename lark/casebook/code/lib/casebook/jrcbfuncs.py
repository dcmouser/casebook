...
class CbFunc:
    def __init__(self, name, description, paramList, returnType, targetsAccepted, funcPointer, astloc=None):
        self.name = name
    ...
    def invoke(self, rmode, env, astloc, argList, targets):
        ...
        return self.funcPointer(rmode, env, astloc, resolvedArgs, targets)
...
class CbParam:
    def __init__(self, name, description, defaultVal, paramCheck, flagResolveIdentifiers):
        ...
        self.name = name
        self.description = description
        self.isRequired = (defaultVal is None)
